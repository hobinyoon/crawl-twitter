...
namespace Conf {
	...
	void _ParseArgs(int argc, char* argv[]) {
		...
		od.add_options()
			("in_file", po::value<string>()->default_value("~/work/castnet-data/youtube/150812-143151-tweets-5667779-noads-3837612"), "Input file")
			("youtube_video_info_file", po::value<string>()
				->default_value("~/work/crawl-twitter/tools/get-youtube-video-details/get-youtube-video-details/video-info-concise", "Concise video info file"))
			("help", "show help message")
			;

		po::positional_options_description pod;
		pod.add("in_file", 1);
		pod.add("youtube_video_info_file", 1);
