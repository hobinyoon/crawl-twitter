...
CREATE DATABASE IF NOT EXISTS twitter2 CHARACTER SET utf8 COLLATE utf8_bin;

CREATE TABLE IF NOT EXISTS twitter2.credentials (
...
CREATE TABLE IF NOT EXISTS twitter2.cred_auth_history (
