...
namespace Conf {
  ...
  void _ParseArgs(int argc, char* argv[]) {
    ...
    od.add_options()
      ("fn_tweets", po::value<string>()->default_value("~/work/cp-mec-data/170702-145200-tweets-690801"), "Input file name")
      ("out_dn", po::value<string>()->default_value(".result"), "Output directory name")
      ("out_fn", po::value<string>()->default_value("insert-users.sql"), "Output file name")
